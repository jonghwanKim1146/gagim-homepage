let GAGIM = (function() {
    ...
    _private.motion01 = function () {
        ...
        txtTl.to('#dTit', {duration: 0.5, text: '일정을 등록해 놓으면', ease: 'ease', delay: 0.5})
        txtTl.to('#cTit', {duration: 0.5, text: '내 요청을 등록하면', ease: 'ease', delay: 0})
        txtTl.to('#dTit', {duration: 0.5, autoAlpha: 0, ease: 'ease', delay: 2})
        txtTl.to('#cTit', {duration: 0.5, autoAlpha: 0, ease: 'ease', delay: -1})
        txtTl.to('#mainTit', {duration: 1, text: '매칭이 되어<br>알림을 전송해요', ease: 'ease', delay: 0})

        // top
        ttl.to('#mainTit', {duration: 0.5, top: 20, ease: 'ease', delay: 2});
        ...
        ttl.to('#notiBox', {duration: 0.5, alpha: 1, ease: 'Back.easeOut', delay: 3});
        ...
        dtl.to('#dPhone', {duration: 0.3, alpha: 1, y: 0, ease: 'ease', delay: 0.5});
        ...
        dtl.to('#dPhoneBox', {duration: 0.3, autoAlpha: 0, delay: 1});
        ...
        ctl.to('#cBox', {height: '0%', duration: 0.5, delay: 0});
    }
    _public.motion02 = function () {
        ...
        ctl.to('#cBox', {height: '0', duration: 1, delay: 1.5});
    }
    _public.motion03 = function () {
        txtTl.to('#mainTit', {duration: 0.5, text: '약속 시간에 맞춰<br>미션을 수행해요', ease: 'ease', delay: 0.5})
